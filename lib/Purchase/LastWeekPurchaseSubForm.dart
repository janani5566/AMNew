...
class PurchaseLastWeekPage extends StatefulWidget {
  @override
  _PurchaseLastWeekPageState createState() => _PurchaseLastWeekPageState();
}

class _PurchaseLastWeekPageState extends State<PurchaseLastWeekPage> {
  ...
  Future<void> fetchData() async {
    ...
    if (jsonData['LastWeekPurchase_Detail'] != null) {
      var lastWeekSalesDetails = jsonData['LastWeekPurchase_Detail'] as List;

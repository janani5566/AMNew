...
class TodayPurchasePaymentPage extends StatefulWidget {
  @override
  _TodayPurchasePaymentPageState createState() =>
      _TodayPurchasePaymentPageState();
}

class _TodayPurchasePaymentPageState extends State<TodayPurchasePaymentPage> {
  ...
  Future<void> fetchData() async {
    ...
    if (jsonData['PurchasePayment_TodayDetail'] != null) {
      var lastWeekSalesDetails =
          jsonData['PurchasePayment_TodayDetail'] as List;
          ...
          child: Column(
            children: [
              ...
              if (tableData.isNotEmpty)
                ...tableData.map((data) {
                  var date = data['payno'].toString();
                  var dateno = data['agentname'].toString();

...
class PurchaseLastMonthPage extends StatefulWidget {
  @override
  _PurchaseLastMonthPageState createState() => _PurchaseLastMonthPageState();
}

class _PurchaseLastMonthPageState extends State<PurchaseLastMonthPage> {
  ...
  Future<void> fetchData() async {
    String apiUrl =
        'http://amsupermarket.ddns.net:82/LastMonthPurchase-Detail/';
    http.Response response = await http.get(Uri.parse(apiUrl));
    var jsonData = json.decode(response.body);

    if (jsonData['LastMonthPurchase_Detail'] != null) {
      var lastWeekSalesDetails = jsonData['LastMonthPurchase_Detail'] as List;

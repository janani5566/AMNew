...
class PurchaseCurrentWeekPage extends StatefulWidget {
  @override
  _PurchaseCurrentWeekPageState createState() =>
      _PurchaseCurrentWeekPageState();
}

class _PurchaseCurrentWeekPageState extends State<PurchaseCurrentWeekPage> {
  ...
  Future<void> fetchData() async {
    ...
    if (jsonData['CurrentWeekPurchase_Detail'] != null) {
      var lastWeekSalesDetails = jsonData['CurrentWeekPurchase_Detail'] as List;

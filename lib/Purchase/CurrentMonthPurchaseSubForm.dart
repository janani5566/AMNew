...
class PurchaseCurrentMonthPage extends StatefulWidget {
  @override
  _PurchaseCurrentMonthPageState createState() =>
      _PurchaseCurrentMonthPageState();
}

class _PurchaseCurrentMonthPageState extends State<PurchaseCurrentMonthPage> {
  ...
  Future<void> fetchData() async {
    String apiUrl =
        'http://amsupermarket.ddns.net:82/CurrentMonthPurchase-Detail/';
    http.Response response = await http.get(Uri.parse(apiUrl));
    var jsonData = json.decode(response.body);

    if (jsonData['CurrentMonthPurchase_Detail'] != null) {
      var lastWeekSalesDetails =
          jsonData['CurrentMonthPurchase_Detail'] as List;
